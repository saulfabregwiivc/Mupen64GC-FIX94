...
void Func_Credits()
{
...
#ifdef HW_RVL
	strcat(CreditsInfo,"Mupen64GC-FIX94 Wii\n");
#else
	strcat(CreditsInfo,"Mupen64GC-FIX94 GameCube\n");
#endif
	strcat(CreditsInfo,"Unofficial saulfabreg Edition r4\n");
	...
	strcat(CreditsInfo,"FIX94 - original Mupen64GC-FIX94\n");
#ifdef HW_RVL
